...
QPs = ['22','27','32','37']
fout = open('parsed_BD_results.csv','w')
	...
	for dir in os.listdir('./'):
		if seq in dir:
			if seq == 'BasketballDrill' and 'BasketballDrillText' in dir:
				found = found
			elif seq == 'RaceHorses' and 'RaceHorsesC' in dir:
				found = found
			elif seq == 'BasketballDrillText' and 'BasketballDrill_' in dir:
				found = found
			elif seq == 'RaceHorsesC' and 'RaceHorses_' in dir:
				found = found
			else:
				found = True
